...
conda env config vars set scanBit_version=0.8.0 # this should match the version of scanBit you are using
...
call_variants_single_cell(
    bam_to_use = "/home/gdrobertslab/lab/Counts_2/S0059/possorted_genome_bam.bam",
...
single_call_meta <-
    ...
    pivot_wider(
        id_cols = c(cell_barcode, tumor_call_sum, normal_call_sum, prop_tumor_call),
        names_from = pos,
